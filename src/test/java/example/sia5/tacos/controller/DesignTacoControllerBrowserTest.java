...
@Ignore("Ignore for now...will revisit and fix Chrome Driver issue")
...
//  private IngredientRepository ingredientRepository;
  ...
  public void testDesignATacoPage() throws Exception {
    ...
    assertIngredient(wrapGroup, 2, "BOWL", "Bowl");
    
    WebElement proteinGroup = ingredientGroups.get(1);
    List<WebElement> proteins = proteinGroup.findElements(By.tagName("div"));
    assertEquals(3, proteins.size());
    assertIngredient(proteinGroup, 0, "GRBF", "Seasoned Ground Beef");
    assertIngredient(proteinGroup, 1, "FJBF", "Grilled Fajita Beef");
    assertIngredient(proteinGroup, 2, "FJCK", "Grilled Fajita Chicken");
  }
